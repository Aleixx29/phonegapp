var LocalStorageStore = function(successCallback, errorCallback) {
    ...
    var employees = [
        ...
        {"id": 2, "firstName": "Arnaud", "lastName": "Prémel-Cabic", "title":"Etudiant ISEN, Ouest", "managerId": 0, "city":"Brest, BRES", "cellPhone":"+33611223344", "officePhone":"+3311223344", "email":"arnaud.premel-cabic@isen-ouest.yncrea.fr"}
        ];
